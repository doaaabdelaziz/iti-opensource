...
function memoryFlipTile(tile,val){
	 ...
	 else if(memory_values.length == 1)
	{
            ...
            if(memory_values[0] == memory_values[1])
		{
			...
			{
			alert("Do yuo want to continue");
                    alert("Board cleared... generating new next level board");
	...
	else
	 {
                function flip2Back()
		{
                    ...
                    tile_1.style.background = 'url(20.gif) repeat';
                    tile_1.innerHTML = "";
                    tile_2.style.background = 'url(20.gif) no-repeat';
                    tile_2.innerHTML = "";
                    // Clear both arrays
                    memory_values = [];
                    memory_tile_ids = [];
        ...
        if(memory_values1.length == 0){
            ...
            if(memory_values1[0] == memory_values1[1]){
                ...
                function flip2Back(){
                    ...
                    tile_1.style.background = 'url(6.jpeg) repeat';
                    tile_1.innerHTML = "";
                    tile_2.style.background = 'url(6.jpeg) no-repeat';
                    tile_2.innerHTML = "";
                    // Clear both arrays
                    memory_values1 = [];
                    memory_tile_ids1 = [];
